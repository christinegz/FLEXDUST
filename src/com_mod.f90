...
! NIK: 31.01.2013- parameters for in-cloud scavening
  ...
  real :: sw(0:nxmax-1,0:nymax-1,1,2)
  real :: svw(0:nxmax-1,0:nymax-1,1,2)
  real :: st(0:nxmax-1,0:nymax-1,1,2)
  real :: cvh(0:nxmax-1,0:nymax-1,1,2)
  real :: cvl(0:nxmax-1,0:nymax-1,1,2)
  ...
  real :: svwn(0:nxmaxn-1,0:nymaxn-1,1,2,maxnests)
  real :: cvln(0:nxmaxn-1,0:nymaxn-1,1,2,maxnests)
  real :: cvhn(0:nxmaxn-1,0:nymaxn-1,1,2,maxnests)
  real :: stn(0:nxmaxn-1,0:nymaxn-1,1,2,maxnests)
